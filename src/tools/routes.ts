...
export const toolComponents: Partial<Record<string, LazyExoticComponent<ComponentType>>> = {
  ...
  'screenshot-redaction': lazy(() => import('./screenshot-redaction/ScreenshotRedaction')),
  ...
  'text-encoding-converter': lazy(() => import('./text-encoding-converter/TextEncodingConverter')),
